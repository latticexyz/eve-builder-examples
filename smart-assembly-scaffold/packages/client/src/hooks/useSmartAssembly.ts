...
export function useSmartAssembly() {
	...
	// const smartStorageUnitInvs = useRecord({
	// 	stash: worldStash,
	// 	table: mudConfig.namespaces.eveworld.tables.InventoryItemTable,
	// 	key: {
	// 		smartObjectId,
	// 		smartStorageUnitInv,
	// 	},
	...
	// const smartStorageUnitEphInv = useRecord({
	// 	stash: worldStash,
	// 	table: mudConfig.namespaces.eveworld.tables.EphemeralInvTable,
	// 	key: {
	// 		smartObjectId,
	// 	},
	// });
